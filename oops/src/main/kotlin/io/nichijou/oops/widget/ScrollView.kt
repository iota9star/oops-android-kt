...
open class ScrollView @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : ScrollView(context, attrs), OopsLifecycleOwner {
  private val lifecycleRegistry = LifecycleRegistry(this)
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      colorAccent.observe(this@ScrollView, Observer {
        EdgeGlowUtil.setEdgeGlowColor(this@ScrollView, it)
      })
    }
  }
