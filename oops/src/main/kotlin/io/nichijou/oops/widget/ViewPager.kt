...
open class ViewPager @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : ViewPager(context, attrs), OopsLifecycleOwner {
  private val lifecycleRegistry = LifecycleRegistry(this)
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      colorAccent.observe(this@ViewPager, Observer {
        EdgeGlowUtil.setEdgeGlowColor(this@ViewPager, it)
      })
    }
  }
