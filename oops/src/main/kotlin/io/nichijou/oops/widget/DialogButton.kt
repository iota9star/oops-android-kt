...
open class DialogButton @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : AppCompatButton(context, attrs), OopsLifecycleOwner {
  private val lifecycleRegistry = LifecycleRegistry(this)
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      colorAccent.observe(this@DialogButton, Observer(::setTextColor))
    }
  }
