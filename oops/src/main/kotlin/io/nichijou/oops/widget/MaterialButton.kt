...
open class MaterialButton @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : MaterialButton(context, attrs), OopsLifecycleOwner {
  ...
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      materialButtonColor(
        ...
        isDark
      ).observe(this@MaterialButton, Observer(::tint))
    }
  }
