...
internal class OopsTabImageView(context: Context, @Nullable attrs: AttributeSet?) : AppCompatImageView(context, attrs) {
    ...
    override fun onAttachedToWindow() {
        ...
        tabTextColor = (this.parent?.parent?.parent as? OopsTabLayout?)?.getIconColor()
