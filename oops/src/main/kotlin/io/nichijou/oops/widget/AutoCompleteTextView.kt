...
class AutoCompleteTextView(context: Context, @Nullable attrs: AttributeSet?, private val enabledLiveNow: Boolean = true) : AppCompatAutoCompleteTextView(context, attrs), OopsLifecycleOwner {
