...
class NavigationView(context: Context, @Nullable attrs: AttributeSet?, private val enabledLiveNow: Boolean = true) : NavigationView(context, attrs), OopsLifecycleOwner {
