...
open class ListView @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : ListView(context, attrs), OopsLifecycleOwner {
  private val lifecycleRegistry = LifecycleRegistry(this)
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      colorAccent.observe(this@ListView, Observer {
        EdgeGlowUtil.setEdgeGlowColor(this@ListView, it)
      })
    }
  }
