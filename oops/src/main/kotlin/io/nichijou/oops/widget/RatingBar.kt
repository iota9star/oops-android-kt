...
class RatingBar(context: Context, @Nullable attrs: AttributeSet?, private val enabledLiveNow: Boolean = true) : AppCompatRatingBar(context, attrs), OopsLifecycleOwner {
