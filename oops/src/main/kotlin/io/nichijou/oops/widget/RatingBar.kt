...
open class RatingBar @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : AppCompatRatingBar(context, attrs), OopsLifecycleOwner {
  ...
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      isDarkColor(live(backgroundAttrValue, colorAccent)!!)
        .observe(this@RatingBar, Observer(::tint))
    }
  }
