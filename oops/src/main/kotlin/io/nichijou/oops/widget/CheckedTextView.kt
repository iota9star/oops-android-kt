...
class CheckedTextView(context: Context, @Nullable attrs: AttributeSet?, private val enabledLiveNow: Boolean = true) : AppCompatCheckedTextView(context, attrs), OopsLifecycleOwner {
