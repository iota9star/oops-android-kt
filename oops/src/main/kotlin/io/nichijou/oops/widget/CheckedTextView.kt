...
open class CheckedTextView @JvmOverloads constructor(context: Context, @Nullable attrs: AttributeSet? = null) : AppCompatCheckedTextView(context, attrs), OopsLifecycleOwner {
  ...
  override fun liveInOops() {
    this.activity().applyOopsThemeStore {
      isDarkColor(live(backgroundAttrValue, colorAccent)!!)
        .observe(this@CheckedTextView, Observer(::tint))
    }
  }
