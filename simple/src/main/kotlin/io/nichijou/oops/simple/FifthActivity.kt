...
class FifthActivity : OopsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.menu.findItem(R.id.action_next).setOnMenuItemClickListener {
            val intent = Intent(this@FifthActivity, classes[Random().nextInt(classes.size)])
                ...
                .listener(GlidePalette.with(u)
                        .intoCallBack { p ->
                            p?.swatches?.forEach {
                                ...
                                setLightStatusBarCompat(it.rgb.isColorLight())
                                return@forEach
                            }
                        }
                )
